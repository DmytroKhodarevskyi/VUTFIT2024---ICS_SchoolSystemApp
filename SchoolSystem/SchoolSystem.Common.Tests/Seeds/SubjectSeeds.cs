...
public static class SubjectSeeds
{
    ...
    public static void Seed(this ModelBuilder modelBuilder) =>
        modelBuilder.Entity<SubjectEntity>().HasData(
            IZP with{ StudentSubjects = Array.Empty<StudentSubjectEntity>(), Activities = Array.Empty<ActivityEntity>()}, IUS with{ StudentSubjects = Array.Empty<StudentSubjectEntity>(), Activities = Array.Empty<ActivityEntity>()},
