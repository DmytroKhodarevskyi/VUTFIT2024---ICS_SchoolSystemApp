...
public sealed class EvaluationFacadeTest : CRUDFacadeTestsBase
{
    ...
    //     // Arrange
    //     
    //     var subject = new SubjectDetailedModel(Name: "Math", Abbreviation: "MTH")
    //     {
    ...
    //     
    //     var evaluation = await _evaluationFacadeSUT.GetFinalEvaluationOfStudentForSubject(student.Name, student.Surname, subject.Name);
    //     
    //     // Assert
